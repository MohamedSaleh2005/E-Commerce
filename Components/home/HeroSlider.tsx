...
export default function HeroSlider() {
    return (
        ...
        <div className='hero'>
            <div>
                <Swiper pagination={{ clickable: true }} modules={[Pagination, Autoplay]} loop={true} autoplay={{ delay: 2500, disableOnInteraction: false, }} className="lg:h-95">
                    ...
                    <SwiperSlide>
                        ...
                        <div className='content'>
                            ...
                            <Link href={""} className='btn rounded-2xl bg-(--main-color) text-white text-[10px]'>Shop Now</Link>
                        </div>
